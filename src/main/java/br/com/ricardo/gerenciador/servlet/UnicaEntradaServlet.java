...
//		
		...
		String nomeDaClasse = "br.com.ricardo.gerenciador.acao." + paramAcao;
		...
		/*
		 * if (paramAcao.equals("ListaEmpresas")) { ListaEmpresa acao = new
		 * ListaEmpresa(); nome = acao.executa(request, response);
		 * 
		 ...
		 * response); } else if(paramAcao.equals("NovaEmpresa")) { NovaEmpresa acao =
		 * new NovaEmpresa(); nome = acao.executa(request, response);
		 * 
		 * 
		 * }
		 * 
